...
function report(name, results) {
  ...
  var mibPerSecond = results.bytesPerSecond ? (results.bytesPerSecond / 1024 / 1024).toFixed(2) + " MiB/s" : "";
  log.print(pad(name, 25, true) + " " + pad(ops, 20) + " " + pad(msPerOp, 20) + " " + pad(opsPerSecond, 20) + " " + pad(mibPerSecond, 15));
}
